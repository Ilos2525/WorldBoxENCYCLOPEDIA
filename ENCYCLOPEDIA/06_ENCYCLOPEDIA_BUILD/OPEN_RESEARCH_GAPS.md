...
Состав вкладок debug-окна закрыт: **Абсолютно все / Отладочные стрелки / Карта / Курсор / Читы / Система**.  
Остаётся OPEN: полный список кнопок на каждой вкладке + эффекты; burger ×11; сохраняемость опций.
