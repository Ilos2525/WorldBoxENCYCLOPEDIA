...
2. Вкладки `UiDebugButton` = имена `DebugOption` (точный набор prefab **не** выгружался — REQUIRES LIVE)
...
| SystemCityTasks / SystemUpdateUnits / … off | останавливает тики |
| CitizenJob* toggle | фильтр слотов работ |
| MakeUnitsFollowCursor | чит поведения |
